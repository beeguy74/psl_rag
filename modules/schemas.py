"""
Schema definitions for PSL RAG LanceDB integration.

This module defines the data structures and validation functions
for PSL document records and database operations.
"""
